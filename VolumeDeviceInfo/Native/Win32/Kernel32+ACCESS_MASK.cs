...
namespace RJCP.Native.Win32
{
    ...
    {
        /// <summary>
        /// The ACCESS_MASK type is a bitmask that specifies a set of access rights in the access mask of an access
        /// control entry.
        /// </summary>
        /// <remarks>
        ...
        public readonly struct ACCESS_MASK : IEquatable<ACCESS_MASK>, IFormattable
        {
            ...
            /// <summary>
            /// Generic access rights for a noninteractive window station object. The system assigns noninteractive
            ...
            /// </summary>
            public InteractiveWindowStationGenericRight InteractiveWindowStationGenericRights => (InteractiveWindowStationGenericRight)GenericRights;

            /// <summary>
            /// Gets the generic rights of this value for non-interactive window stations.
            /// </summary>
            public NonInteractiveWindowStationGenericRight NonInteractiveWindowStationGenericRights => (NonInteractiveWindowStationGenericRight)GenericRights;
