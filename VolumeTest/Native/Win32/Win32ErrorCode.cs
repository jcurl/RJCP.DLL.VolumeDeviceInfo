...
namespace VolumeTest.Native.Win32
{
    internal enum Win32ErrorCode
    {
        ...
        /// Control Panel to change the computer name and try again. If joining a workgroup, choose another workgroup
        /// name.
        /// </summary>
        ...
        /// following errors which is guaranteed to be in the filter. In this case information is lost, however, the
        ...
        /// SIDs in the security descriptor could not be translated into a GUID that could be stored by the file system.
        /// This causes the protection attempt to fail, which may cause a file creation attempt to fail.
        /// </summary>
        ERROR_NO_GUID_TRANSLATION = 0x00000230,

        /// <summary>
        /// Indicates that an attempt was made to grow an LDT by setting its size, or that the size was not an even
        /// number of selectors.
        /// </summary>
        ...
        /// <summary>
        /// Indicates a process has too many threads to perform the requested action. For example, assignment of a
        ...
        /// <summary>
        /// {Application Error} The application was unable to start correctly (0x%lx). Click OK to close the
        /// application.
        /// </summary>
        ...
        /// DebugActiveProcess API request. You may choose OK to terminate the process, or Cancel to ignore the error.
        /// </summary>
        ...
        /// left in an inconsistent state. The entrypoint should be declared as WINAPI or STDCALL. Select YES to fail
        /// the DLL load. Select NO to continue execution. Selecting NO may cause the application to operate
        /// incorrectly.
        /// </summary>
        ...
        /// left in an inconsistent state. The callback entrypoint should be declared as WINAPI or STDCALL. Selecting OK
        ...
        /// prevent users from changing back to a familiar, but potentially discovered, password. If you feel your
        /// password has been compromised then please contact your administrator immediately to have a new one assigned.
        /// </summary>
        ...
        /// properly. The relocation occurred because the DLL %hs occupied an address range reserved for Windows system
        ...
        /// your virtual memory paging file. During this process, memory requests for some applications may be denied.
        ...
        /// that a transaction commit was previously aborted. The commit has NOT been completed, but has not been rolled
        /// back either (so it may still be committed if desired).
        /// </summary>
        ...
        /// administratively-defined GUID prefix was found. A substitute prefix was used, which will not compromise
        /// system security. However, this may provide a more restrictive access than intended.
        /// </summary>
        ...
        /// <summary>
        /// {Image Relocated} An image file could not be mapped at the address specified in the image file. Local fixes
        ...
        /// redundant copy of the information. This was done because the file system encountered a failure on a member
        /// of the fault-tolerant volume, but was not able to reassign the failing area of the device.
        /// </summary>
        ...
        /// <summary>
        /// {Image Relocated} An image file was mapped at a different address from the one specified in the image file
        /// but fixes will still be automatically performed on the image.
        /// </summary>
        ...
        /// system's memory image of the file is corrupted, or the file could not be recovered because the alternate
        ...
        /// <summary>
        /// The password is too complex to be converted to a LAN Manager password. The LAN Manager password returned is
        /// a NULL string.
        /// </summary>
        ...
        /// <summary>
        /// Either the specified user account is already a member of the specified group, or the specified group cannot
        /// be deleted because it contains a member.
        /// </summary>
        ...
        /// <summary>
        /// This operation is disallowed as it could result in an administration account being disabled, deleted or
        /// unable to logon.
        /// </summary>
        ...
        /// <summary>
        /// Unable to update the password. The value provided for the new password contains values that are not allowed
        /// in passwords.
        /// </summary>
        ...
        /// <summary>
        /// The security account manager (SAM) or local security authority (LSA) server was in the wrong state to
        ...
        /// <summary>
        /// The requested action is restricted for use by logon processes only. The calling process has not registered
        /// as a logon process.
        /// </summary>
        ...
        /// <summary>
        /// Error opening installation log file. Verify that the specified log file location exists and that you can
        /// write to it.
        /// </summary>
        ...
        /// <summary>
        /// This update package could not be opened. Verify that the update package exists and that you can access it,
        /// or contact the application vendor to verify that this is a valid Windows Installer update package.
        /// </summary>
        ERROR_PATCH_PACKAGE_OPEN_FAILED = 0x00000663,

        /// <summary>
        /// This update package could not be opened. Contact the application vendor to verify that this is a valid
        ...
        /// remote session. If you want to install or configure software on the server, contact your network
        /// administrator.
        /// </summary>
        ...
        /// missing, or the upgrade may update a different version of the program. Verify that the program to be
        ...
        /// <summary>
        /// The Windows Installer service is not accessible in Safe Mode. Please try again when your computer is not in
        /// Safe Mode or you can use System Restore to return your machine to a previous good state.
        /// </summary>
        ...
        /// <summary>
        /// The name or security ID (SID) of the domain specified is inconsistent with the trust information for that
        /// domain.
        /// </summary>
        ...
        /// <summary>
        /// Logon Failure: EAS policy requires that the user change their password before this operation can be
        /// performed.
        /// </summary>
        ...
        /// <summary>
        /// The network connection was made successfully, but the user had to be prompted for a password other than the
        ...
        /// <summary>
        /// The encryption algorithm used on the source file needs a bigger key buffer than the one on the destination
        /// file.
        /// </summary>
        ...
        /// <summary>
        /// The log is pinned due to reservation consuming most of the log space. Free some reserved records to make
        /// space available.
        /// </summary>
        ...
        /// <summary>
        /// The attempt to commit the Transaction completed, but it is possible that some portion of the transaction
        /// tree did not commit successfully due to heuristics. Therefore it is possible that some data modified in the
        ...
        /// <summary>
        /// A rollback could not be scheduled because a previously scheduled rollback has already executed or been
        ...
        /// <summary>
        /// The task you are trying to do can't be completed because Remote Desktop Services is currently busy. Please
        /// try again in a few minutes. Other users should still be able to log on.
        /// </summary>
        ...
        /// <summary>
        /// The requested operation can be performed only on the system console. This is most often the result of a
        ...
        /// <summary>
        /// The requested session cannot be controlled remotely. This may be because the session is disconnected or does
        ...
        /// number is currently being used by another user. Please call your system administrator to obtain a unique
        /// license number.
        /// </summary>
        ...
        /// <summary>
        /// The user %s\\%s is currently logged on to this computer. Only the current user or an administrator can log
        /// on to this computer.
        /// </summary>
        ERROR_CTX_SESSION_IN_USE = 0x00001B96,

        /// <summary>
        /// The user %s\\%s is already logged on to the console of this computer. You do not have permission to log in
        /// at this time. To resolve this issue, contact %s\\%s and have them log off.
        /// </summary>
        ...
        /// <summary>
        /// The file replication service cannot satisfy the request because the user has insufficient privileges. The
        /// event log may have more information.
        /// </summary>
        FRS_ERR_INSUFFICIENT_PRIV = 0x00001F47,

        /// <summary>
        /// The file replication service cannot satisfy the request because authenticated RPC is not available. The
        /// event log may have more information.
        /// </summary>
        FRS_ERR_AUTHENTICATION = 0x00001F48,

        /// <summary>
        /// The file replication service cannot satisfy the request because authenticated RPC is not available on the
        ...
        /// <summary>
        /// The file replication service on the domain controller cannot communicate with the file replication service
        /// on this computer. The event log may have more information.
        /// </summary>
        FRS_ERR_PARENT_TO_CHILD_COMM = 0x00001F4C,

        /// <summary>
        /// The file replication service cannot populate the system volume because of an internal error. The event log
        /// may have more information.
        /// </summary>
        FRS_ERR_SYSVOL_POPULATE = 0x00001F4D,

        /// <summary>
        /// The file replication service cannot populate the system volume because of an internal timeout. The event log
        /// may have more information.
        /// </summary>
        ...
        /// <summary>
        /// The file replication service cannot stop replicating the system volume because of an internal error. The
        /// event log may have more information.
        /// </summary>
        ...
        /// <summary>
        /// The requested operation could not be performed because the directory service is not the master for that type
        /// of operation.
        /// </summary>
        ...
        /// as a protective mechanism when the system determines a significant portion of relative identifiers (RIDs)
        /// have been exhausted. Please see http://go.microsoft.com/fwlink/?LinkId=228610 for recommended diagnostic
        /// steps and the procedure to re-enable account creation.
        /// </summary>
        ...
        /// class, or adding an optional attribute to the special class Top that is not a backlink attribute (directly
        ...
        /// functional level or AD LDS Configuration Set functional level. You must raise the AD DS Forest functional
        /// level or AD LDS Configuration Set functional level before this server can become an AD DS Domain Controller
        /// or an AD LDS Instance in this Forest or Configuration Set.
        /// </summary>
        ...
        /// Please retry the operation using the provider associated with this account. If this is an online provider
        /// please use the provider's online site.
        /// </summary>
        ERROR_INCORRECT_ACCOUNT_TYPE = 0x000021C6,

        /// <summary>
        /// The operation failed because the addition/modification referenced an inbound forest-wide trust that is not
        /// present.
        /// </summary>
        ...
        /// <summary>
        /// An unexpected crypto error was encountered. Zone signing may not be operational until this error is
        /// resolved.
        /// </summary>
        ...
        /// <summary>
        /// The DNS server cannot accept any more signing keys with the specified algorithm and KSK flag value for this
        /// zone.
        /// </summary>
        ...
        /// <summary>
        /// This operation could not be completed because the DNS server listed as the current key master for this zone
        /// is down or misconfigured. Resolve the problem on the current key master for this zone or use another DNS
        /// server to seize the key master role.
        /// </summary>
        DNS_ERROR_BAD_KEYMASTER = 0x000023A2,

        /// <summary>
        /// This operation could not be completed because the DNS server has been configured with DNSSEC features
        /// disabled. Enable DNSSEC on the DNS server.
        /// </summary>
        ...
        /// <summary>
        /// Hash collision detected during NSEC3 signing. Specify a different user-provided salt, or use a randomly
        /// generated salt, and attempt to sign the zone again.
        /// </summary>
        ...
        /// <summary>
        /// This operation is not allowed while the DNS server is loading zones in the background. Please try again
        /// later.
        /// </summary>
        ...
        /// <summary>
        /// Name resolution policy table has been corrupted. DNS resolution will fail until it is fixed. Contact your
        ...
        /// <summary>
        /// The operation failed because the domain naming master FSMO role could not be reached. The domain controller
        /// holding the domain naming master FSMO role is down or unable to service the request or is not running
        ...
        /// <summary>
        /// An operation on a socket could not be performed because the system lacked sufficient buffer space or because
        /// a queue was full.
        /// </summary>
        ...
        /// <summary>
        /// This is usually a temporary error during hostname resolution and means that the local server did not receive
        ...
        /// require a private key. Contact your Network Security administrator about replacing with a certificate that
        /// has a private key.
        /// </summary>
        ...
        /// <summary>
        /// Failed to obtain Kerberos server credentials for ISAKMP/ERROR_IPSEC_IKE service. Kerberos authentication
        /// will not function. The most likely reason for this is lack of domain membership. This is normal if your
        ...
        /// <summary>
        /// Two or more components referenced directly or indirectly by the application manifest have the same COM
        /// server CLSIDs.
        /// </summary>
        ERROR_SXS_DUPLICATE_CLSID = 0x000036C7,

        /// <summary>
        /// Two or more components referenced directly or indirectly by the application manifest have proxies for the
        /// same COM interface IIDs.
        /// </summary>
        ...
        /// <summary>
        /// The query result is stale / invalid. This may be due to the log being cleared or rolling over after the
        /// query result was created. Users should handle this code by releasing the query result object and reissuing
        /// the query.
        /// </summary>
        ...
        /// <summary>
        /// An expression can only be followed by a change of scope operation if it itself evaluates to a node set and
        /// is not already part of some other change of scope operation.
        /// </summary>
        ...
        /// <summary>
        /// Left hand side arguments to binary operators must be either attributes, nodes or variables and right hand
        /// side arguments must be constants.
        /// </summary>
        ERROR_EVT_FILTER_INVARG = 0x00003AA8,

        /// <summary>
        /// A step operation must involve either a node test or, in the case of a predicate, an algebraic expression
        /// against which to test each node in the node set identified by the preceding node set can be evaluated.
        /// </summary>
        ...
        /// <summary>
        /// The xpath expression exceeded supported complexity. Please simplify it or split it into two or more simple
        /// expressions.
        /// </summary>
        ...
        /// <summary>
        /// The publisher has been disabled and its resource is not available. This usually occurs when the publisher is
        /// in the process of being uninstalled or upgraded.
        /// </summary>
        ...
        /// <summary>
        /// The log of the subscription is in disabled state, and can not be used to forward events to. The log must
        /// first be enabled before the subscription can be activated.
        /// </summary>
        ERROR_EC_LOG_DISABLED = 0x00003AE9,

        /// <summary>
        /// When forwarding events from local machine to itself, the query of the subscription can't contain target log
        /// of the subscription.
        /// </summary>
        ...
        /// <summary>
        /// The service has an invalid run level setting. The run level for a service must not be higher than the run
        /// level of its dependent services.
        /// </summary>
        ERROR_INVALID_RUNLEVEL_SETTING = 0x00003C29,

        /// <summary>
        /// The requested run level switch cannot be completed successfully since one or more services will not stop or
        /// restart within the specified timeout.
        /// </summary>
        ...
        /// <summary>
        /// The signature is invalid. To register in developer mode, AppxSignature.p7x and AppxBlockMap.xml must be
        /// valid or should not be present.
        /// </summary>
        ...
        /// <summary>
        /// The specified computer account could not be found. Contact an administrator to verify the account is in the
        /// domain. If the account has been deleted unjoin, reboot, and rejoin the domain.
        /// </summary>
        ...
        /// <summary>
        /// An attempt to resolve the DNS name of a domain controller in the domain being joined has failed. Please
        /// verify this client is configured to reach a DNS server that can resolve DNS names in the target domain. For
        ...
        /// <summary>
        /// Unable to load the specified offline registry hive. Please ensure you have access to the specified path
        /// location and permissions to modify its contents. Running as an elevated administrator may be required.
        /// </summary>
        ...
        /// <summary>
        /// The specified domain controller does not meet the version requirement for this operation. Please select a
        /// domain controller capable of issuing claims.
        /// </summary>
        NERR_DS8DCRequired = 2100 + 620,

        /// <summary>
        /// This operation requires a domain controller which supports LDAP. Please select an LDAP-capable domain
        /// controller.
        /// </summary>
        NERR_LDAPCapableDCRequired = 2100 + 621,

        /// <summary>
        /// A domain controller which meets the version requirement for this operation could not be located. Please
        /// ensure that a domain controller capable of issuing claims is available.
        /// </summary>
        ...
        /// <summary>
        /// The domain controller does not meet the version requirement for this operation. See
        /// http://go.microsoft.com/fwlink/?LinkId=294288 for more information.
        /// </summary>
