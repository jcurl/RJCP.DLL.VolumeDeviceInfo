...
namespace VolumeInfo.Native.Win32
{
    ...
    /// <content>Contains the <see cref="FileAccess"/> nested type.</content>
    internal partial class Kernel32
    {
        ...
        {
            /// <summary>
            /// For a file object, the right to read the corresponding file data. For a directory object, the right to
            /// read the corresponding directory data.
            /// </summary>
            ...
            /// <summary>
            /// For a file object, the right to write data to the file. For a directory object, the right to create a
            /// file in the directory ( <see cref="FILE_ADD_FILE"/>).
            /// </summary>
            ...
            /// <summary>
            /// For a file object, the right to append data to the file. (For local files, write operations will not
            /// overwrite existing data if this flag is specified without <see cref="FILE_WRITE_DATA"/>.) For a
            /// directory object, the right to create a subdirectory ( <see cref="FILE_ADD_SUBDIRECTORY"/>).
            /// </summary>
            ...
            /// <summary>
            /// For a native code file, the right to execute the file. This access right given to scripts may cause the
            ...
            /// <summary>
            /// For a directory, the right to delete a directory and all the files it contains, including read-only
            /// files.
            /// </summary>
