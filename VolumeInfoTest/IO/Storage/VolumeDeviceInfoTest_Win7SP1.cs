namespace VolumeInfo.IO.Storage
{
    ...
    public class VolumeDeviceInfoTest_Win7SP1
    {
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\PhysicalDrive0");
        ...
        public void IsPhysicalDrive0(VolumeDeviceInfo vinfo)
        {
            ...
            Assert.That(vinfo.Disk.ProductId, Is.EqualTo("HGST HEJ423232H9E300"));
            Assert.That(vinfo.Disk.ProductRevision, Is.EqualTo("F6BOA170"));
            Assert.That(vinfo.Disk.SerialNumber, Is.EqualTo("2020202020203646303030304e46304758334338"));
            Assert.That(vinfo.Disk.BusType, Is.EqualTo(BusType.Sata));
            ...
            Assert.That(vinfo.Disk.Guid, Is.EqualTo(Guid.Empty));
        ...
        public void DriveC()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"C:");
        ...
        public void DriveCV()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\?\Volume{5391b1c7-9a5d-11e6-9dbc-806e6f6e6963}");
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\HarddiskVolume1");
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\HarddiskVolume2");
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\HarddiskVolume3");
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\HarddiskVolume4");
        ...
        public void DriveD()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"D:");
        ...
        public void DriveDV()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\?\Volume{5391b1cd-9a5d-11e6-9dbc-806e6f6e6963}");
        ...
        public void DriveE()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"E:");
        ...
        public void DriveEV()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\?\Volume{64314999-9ae3-11e6-b310-0021865a69b8}");
        ...
        private void IsVirtCdRom(VolumeDeviceInfo vinfo)
        {
            ...
            Assert.That(vinfo.Disk.SerialNumber, Is.EqualTo("\r("));
            Assert.That(vinfo.Disk.BusType, Is.EqualTo(BusType.Scsi));
            Assert.That(vinfo.Disk.IsRemovableMedia, Is.True);
            Assert.That(vinfo.Disk.HasCommandQueueing, Is.False);
            Assert.That(vinfo.Disk.ScsiDeviceType, Is.EqualTo(ScsiDeviceType.CdRomDevice));
            Assert.That(vinfo.Disk.ScsiDeviceModifier, Is.EqualTo(0));
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\PhysicalDrive1");
        ...
        {
            Assert.That(vinfo.Disk.VendorId, Is.EqualTo("WD      "));
            Assert.That(vinfo.Disk.ProductId, Is.EqualTo("3200AAJ External"));
            Assert.That(vinfo.Disk.ProductRevision, Is.EqualTo("1.06"));
            Assert.That(vinfo.Disk.SerialNumber, Is.EqualTo("E"));
        ...
        public void DriveF()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"F:");
        ...
        public void DriveFV()
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\?\Volume{455b7dcd-e19f-11e6-b6bc-0021865a69b8}");
        ...
        {
            VolumeDeviceInfo vinfo = new VolumeDeviceInfoSim(Win7Sim, @"\\.\HarddiskVolume5");
